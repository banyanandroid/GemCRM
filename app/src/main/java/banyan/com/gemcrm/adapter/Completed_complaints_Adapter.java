...
public class Completed_complaints_Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        comp_no.setText(result.get(Fragment_Target.TAG_COMP_NO));
        cus_name.setText(result.get(Fragment_Target.TAG_CUSTOMER));
        comp_status.setText(result.get(Fragment_Target.TAG_STATUS));

        String str_product = result.get(Fragment_Target.TAG_PRODUCT_NAME);
